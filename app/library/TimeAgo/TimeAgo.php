...
class TimeAgo
{
    ...
    {
        if (CURRENT_LOCALE_ISO == 'ru' && in_array($label, ['days', 'hours', 'lessThanOneHour', 'months', 'years'])) {
            switch ($label) {
                case 'days':
                    return sprintf(ngettext("%d days ago", "%d days ago", $time), $time);
                    break;
                case 'hours':
                    return sprintf(ngettext("%d hours ago", "%d hours ago", $time), $time);
                    break;
                case 'lessThanOneHour':
                    return sprintf(ngettext("%d minutes ago", "%d minutes ago", $time), $time);
                    break;
                case 'months':
                    return sprintf(ngettext("%d months ago", "%d months ago", $time), $time);
                    break;
                case 'years':
                    return sprintf(ngettext("%d years ago", "%d years ago", $time), $time);
                    break;
            }
        } else {
